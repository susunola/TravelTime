...
<table>
  <tr>
    <td width="33%"><img src="docs/screenshots/traveltime-world-clocks-1.8.13-aligned.jpg" alt="TravelTime World clocks tab"></td>
    <td width="33%"><img src="docs/screenshots/traveltime-calendar-1.8.13-aligned.jpg" alt="TravelTime Calendar tab"></td>
    <td width="33%"><img src="docs/screenshots/traveltime-meeting-planner-1.8.13-aligned.jpg" alt="TravelTime Meeting planner tab"></td>
  </tr>
  <tr>
